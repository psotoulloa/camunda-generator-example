...
public class Products implements JavaDelegate {
    ...
    Map<String, String> env = System.getenv();
		...
		HttpResponse<JsonNode> response1 = Unirest.get(url+"/api/camunda/users/jefemarketing").
    ...
    execution.setVariable("products", Variables.objectValue(map).serializationDataFormat("application/json").create());
	}
