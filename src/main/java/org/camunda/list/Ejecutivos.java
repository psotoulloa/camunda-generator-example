...
public class Ejecutivos implements JavaDelegate {
    ...
    Map<String, String> env = System.getenv();
		...
		HttpResponse<JsonNode> response1 = Unirest.get(url+"/api/camunda/users/ejecutivo").
    ...
    execution.setVariable("ejecutivos", Variables.objectValue(map).serializationDataFormat("application/json").create());
	}
